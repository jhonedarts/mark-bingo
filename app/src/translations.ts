...
export const translations: Record<Locale, Translation> = {
  'pt-BR': {
    ...
    chooseImageHint:
      'Arraste uma imagem aqui ou selecione uma foto reta e nítida. O sistema detectará as linhas e colunas.',
  ...
  es: {
    ...
    chooseImageHint:
      'Arrastra una imagen aquí o selecciona una foto recta y nítida. El sistema detectará filas y columnas.',
  ...
  en: {
    ...
    chooseImageHint:
      'Drag an image here or select a straight, clear photo. The app will detect rows and columns.',
